...
{
    game_data->game_alive = msg[0];
    game_data->game_pause = msg[1];
    game_data->left_player_alive = msg[2];
    game_data->top_player_alive = msg[3];
    game_data->right_player_alive = msg[4];
    game_data->bottom_player_alive = msg[5];
    game_data->left_player_score = ((unsigned char)(msg[6]) << 8) + (unsigned char)(msg[7]);
    ...
    game_data->left_player_pos = ((unsigned char)(msg[14]) << 8) + (unsigned char)(msg[15]);
    ...
    game_data->ball_x = ((unsigned char)(msg[22]) << 8) + (unsigned char)(msg[23]);
